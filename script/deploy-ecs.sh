...
usage="Usage: deploy-ecs.sh [beathovn-app-web|beathovn-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/beathovn:$2"
...
aws ecs update-service --cluster beathovn \
  --no-cli-pager \
  --region "$ecs_region" \
