...
# Lambda URIs are "{+lambda}/{+function}" e.g. "beathovn/ping".
# We also support path matching at the root e.g. "beathovn" but these require definining separate "_root" terraform resources.
