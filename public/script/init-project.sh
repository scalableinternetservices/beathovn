...
git clone https://github.com/rothfels/beathovn.git $SLUG
cd $SLUG
rm -rf .git

sed -i.bak "s/beathovn/$SLUG/g" **/*.tf
sed -i.bak "s/beathovn/$SLUG/g" **/*.ts
sed -i.bak "s/beathovn/$SLUG/g" **/*.yml
sed -i.bak "s/beathovn/$SLUG/g" **/*.sh
sed -i.bak "s/beathovn/$SLUG/g" **/*.json
rm -rf **/*.bak
